    ...
    bcrypt.hash(req.body.password, 10, function(err, hashedPass) {
        ...
        var mailOptions = {
            ...
            * {
            ...
            <p style="font-size: 14px; line-height: 200%;"><span style="font-size: 18px; line-height: 36px;">This is your token : ${user.emailToken}</span></p>
              </div>
...
module.exports = {
    index,show,register,update,destroy,login,changePassword,verifyAccount
}