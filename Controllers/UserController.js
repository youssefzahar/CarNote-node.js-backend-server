            ...
            * {
            ...
            <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #bbbbbb; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">© Shop Name&nbsp; |&nbsp; All Rights Reserved </span></p>
              </div>
...
var mailOptions = {
    ...
    * {
    ...
    <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;">This is your new password: </span></p>
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px; color: #666666;"><strong>${resetPassword}</strong></span></p>
      </div>
...
module.exports = {
    index,show,register,update,destroy,login,changePassword,verifyAccount,forgotPassword
}